...
const Destination = () => {
  ...
  return (
    <section className='py-10 px-5 bg-[rgba(255,255,255,1)] lg:px-24'>
        <div>
        ...
        <div className='relative w-full my-5'>
            <div className="hidden md:block absolute top-1/2 lg:left-[-70px] left-4 z-10">
                <img src={RightArrow} alt="arrow" onClick={() => goToSlide(currentSlide === 0 ? sliders.length - 1 : currentSlide -1 )} className='transform rotate-y-180 bg-white p-2 rounded-full shadow-md'/>
            </div>
            ...
            <div className="hidden md:block absolute top-1/2 lg:right-[-70px] right-4 z-10">
                <img src={RightArrow} alt="arrow" onClick={() => goToSlide((currentSlide + 1) % sliders.length)} className="bg-white p-2 rounded-full shadow-md"/>
            </div>
        </div>

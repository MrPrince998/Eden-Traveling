    ...
    <footer className="bg-[rgba(7,61,55,1)] py-[30px] px-5 w-full lg:px-24 md:bg-[rgba(245,245,245,1)]">
      <div className="md:flex md:justify-between md:items-start md:pt-[70px] md:pb-[94px] md:gap-x-4">
        <div className="text-center">
          <p className="font-medium text-lg text-[rgba(23,195,178,1);]">
            <span className="md:text-black">NEED ANY HELP?</span>
            <br />
            <br />
            <span className="text-white md:text-[#666666]">
              Call 24/7 for any help
            </span>
            <br />
            <span className="font-medium text-2xl">+00 123 456 789</span>
            <br />
            <br />
            <span className="text-white md:text-[#666666]">
            ...
            <br />
            <span className="font-medium text-2xl">support@domain.com</span>
            <br />
            <br />
        ...
        <div className="grid grid-cols-2 justify-center gap-5 mt-[30px] mb-15 md:grid-cols-4">
          <div className="text-white md:text-[#666666]">
            <h1 className="text-lg text-[rgba(23,195,178,1)] font-medium md:text-black">
              COMPANY
            </h1>
          ...
          <div className="text-white md:text-[#666666]">
            ...
            <br />
            <Link to={"/"}>Rewward Program</Link>
            <br />
            <Link to={"/"}>Point Plus</Link>
            <br />
      ...
      <div className="flex justify-between md:border-t-1 border-[rgba(221,221,221,1)] md:pt-[30px]">
        <p className="letter-blue hidden md:block w-full">
          Copyright © 2023 Kunturi Design
        </p>
        <Link to={"/home"}>
          <div className="flex justify-center w-full items-center h-[21px] md:h-[37px] md:justify-end">
            ...
            <h1 className="text-[#17C3B2] font-sans font-medium text-[20px] md:text-[37px] md:font-bold">
              Eden<span className="text-white md:text-black">Travel</span>
            </h1>
          </div>
        </Link>
      </div>
